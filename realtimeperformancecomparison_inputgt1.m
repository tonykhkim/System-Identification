...
state1_data = cat(2,Pos_Y,Vel_Y,Yaw,Yaw_Rate);
input1_data = WSA_rad;
...
figure('Name','realtime normaldistribution_input data gt1')
subplot(2,2,1)
M_1_1=0;
M_3_1=0;
std_1_1=0;
...
% sizestd_1 = length(time1_1)-99;    
% std_1 = zeros(sizestd_1,4);
% std_3 = zeros(sizestd_1,4);

% % %k=500일 때부터 k가 1단위씩 계산할때 
sizestd_1 = length(time1_1)-499;    
std_1 = zeros(sizestd_1,4);
std_3 = zeros(sizestd_1,4);
...
for k = 1:length(time1_1)
    ...
    x1_k(:,k) = evaluate(nss1,x1(:,k),input_1(:,k)); 
    x3_k(:,k) = evaluate(nss2,x1(:,k),input_1(:,k)); 
...
%%%%%% %k=500일 때부터 k가 1단위씩 계산할때 %%%%%%%%%%%%
        std_1(k-499,1) = std_1_1;
        std_1(k-499,2) = std_1_2;
        std_1(k-499,3) = std_1_3;
        std_1(k-499,4) = std_1_4;

        std_3(k-499,1) = std_3_1;
        std_3(k-499,2) = std_3_2;
        std_3(k-499,3) = std_3_3;
        std_3(k-499,4) = std_3_4;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        if (std_1_1 < std_3_1) && (std_1_2 < std_3_2) && (std_1_4 < std_3_4)
            a_1.String = '고속 주회로';
            a_2.String = '고속 주회로';
            a_3.String = '고속 주회로';
            a_4.String = '고속 주회로';
...
%         end
        ...
        %%%%%% gt1을 데이터로 if 문 이용해서 모든 state에서 
...
%고속주회로1 data를 입력했기 때문에 std_1이 std_3보다 작아야하는 것이 정상 = err_std가 0보다 작아야하는 것이 정상
...
subplot(2,2,1);
plot(time1_2,ylin1_1,'r',time1_2,yn1_1,'b--',time1_2,yn3_1,'g-')
hold on
xline(248.741,'k')
...
subplot(2,2,2);
plot(time1_2,ylin1_2,'r',time1_2,yn1_2,'b--',time1_2,yn3_2,'g-')
hold on
xline(211.641,'k')
...
subplot(2,2,3);
plot(time1_2,ylin1_3,'r',time1_2,yn1_3,'b--',time1_2,yn3_3,'g-')
hold on
xline(255.311,'k')
...
subplot(2,2,4);
plot(time1_2,ylin1_4,'r',time1_2,yn1_4,'b--',time1_2,yn3_4,'g-')
hold on
xline(256.491,'k')
...
[minmax_input,minmax_vel_x]=analLocalmotion(gt1,input1_data,comparison_index)
analFullmotion2(gt3,input3_data,minmax_input,'gt3')
analFullmotion2(gt4,input4_data,minmax_input,'gt4')
